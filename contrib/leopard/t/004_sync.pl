...
$node_subscriber->safe_psql('postgres', "CREATE TABLE tab_rep_next (a int) USING leopard");

# setup structure with existing data on publisher
$node_publisher->safe_psql('postgres',
	"CREATE TABLE tab_rep_next (a) USING leopard AS SELECT generate_series(1,10)");
