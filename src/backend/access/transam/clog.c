...
CLOGShmemSize(void)
{
	return SimpleLruShmemSize(CLOGShmemBuffers(), CLOG_LSNS_PER_PAGE, 1);
}
...
CLOGShmemInit(void)
{
	...
	SimpleLruInit(XactCtl, "Xact", CLOGShmemBuffers(), CLOG_LSNS_PER_PAGE, 1,
				  XactSLRULock, "pg_xact", LWTRANCHE_XACT_BUFFER,
				  LWTRANCHE_XACT_BUFFER_MAPPING, SYNC_HANDLER_CLOG);
