					...
					Oid *mapped_tables)
{
	 ...
	 */
	{
		...
		rel2->rd_newRelfilenumberSubid = rel1->rd_newRelfilenumberSubid;
		rel2->rd_firstRelfilenumberSubid = rel1->rd_firstRelfilenumberSubid;
		RelationAssumeNewRelfilenumber(rel1);
