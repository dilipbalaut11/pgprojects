...
static const CompressionRoutine cmroutine = {
	.type = T_CompressionRoutine,
	.cmcompress = pglz_cmcompress,
	.cmdecompress = pglz_cmdecompress,
	.cmdecompress_slice = pglz_cmdecompress_slice
};
