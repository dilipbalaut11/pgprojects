...
$gnat->init;
$gnat->append_conf('postgresql.conf', "shared_preload_libraries = 'leopard'");
$gnat->start;
$gnat->safe_psql('postgres', "CREATE EXTENSION leopard WITH SCHEMA public");
$gnat->stop;
$gnat->append_conf('postgresql.conf', "default_table_access_method = 'leopard'");
