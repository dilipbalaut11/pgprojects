...
$node_publisher->safe_psql('postgres', "CREATE TABLE tab_1 (a int) USING leopard");
$node_publisher->safe_psql('postgres',
	"INSERT INTO tab_1 SELECT generate_series(1,10)");

# Create table on subscriber
$node_subscriber->safe_psql('postgres', "CREATE TABLE tab_1 (a int) USING leopard");
...
$node_publisher->safe_psql('postgres', "CREATE TABLE tab_2 (a int) USING leopard");
$node_publisher->safe_psql('postgres',
	"INSERT INTO tab_2 SELECT generate_series(1,10)");

# Create a new table on subscriber
$node_subscriber->safe_psql('postgres', "CREATE TABLE tab_2 (a int) USING leopard");
