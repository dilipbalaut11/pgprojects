...
/*
 * Return the compression method stored in the compressed attribute Returns
...
pg_column_compression(PG_FUNCTION_ARGS)
{
	...
	compression = GetCompressionNameFromOid(GetCompressionOidFromCompressionId(
											TOAST_COMPRESS_METHOD(varvalue)));
