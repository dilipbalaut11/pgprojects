...
SubTransSetParent(TransactionId xid, TransactionId parent)
{
	...
	lock = SimpleLruPageNoGetLock(SubTransCtl, pageno);
...
SubTransGetParent(TransactionId xid)
{
	...
	LWLockRelease(SimpleLruPageNoGetLock(SubTransCtl, pageno));
...
{
	int			slotno;
	LWLock	   *lock = SimpleLruPageNoGetLock(SubTransCtl, 0);
...
StartupSUBTRANS(TransactionId oldestActiveXID)
{
	 ...
	 */
	SimpleLruControlLockAcquire(SubTransCtl, LW_EXCLUSIVE);
	...
	SimpleLruControlLockRelease(SubTransCtl);
}
