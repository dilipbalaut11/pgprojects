...
/*
 *	smgrclosenode() -- Close SMgrRelation object for given RelFileLocator,
 *					   if one exists.
 *
 ...
 */
void
smgrclosenode(RelFileLocatorBackend rlocator)
{
	SMgrRelation reln;
...
smgrdounlinkall(SMgrRelation *rels, int nrels, bool isRedo)
{
	 ...
	 */
	rnodes = palloc(sizeof(RelFileLocatorBackend) * nrels);
	for (i = 0; i < nrels; i++)
	{
