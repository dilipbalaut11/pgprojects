...
$node_primary->append_conf('postgresql.conf', "shared_preload_libraries = 'leopard'");
$node_primary->start;
$node_primary->safe_psql('postgres', "CREATE EXTENSION leopard WITH SCHEMA public");
$node_primary->stop;
$node_primary->append_conf('postgresql.conf', "default_table_access_method = 'leopard'");
...
$node_primary2->append_conf('postgresql.conf', "shared_preload_libraries = 'leopard'");
$node_primary2->start;
$node_primary2->safe_psql('postgres', "CREATE EXTENSION leopard WITH SCHEMA public");
$node_primary2->stop;
$node_primary2->append_conf('postgresql.conf', "default_table_access_method = 'leopard'");
...
$node_primary3->append_conf('postgresql.conf', "shared_preload_libraries = 'leopard'");
$node_primary3->start;
$node_primary3->safe_psql('postgres', "CREATE EXTENSION leopard WITH SCHEMA public");
$node_primary3->stop;
$node_primary3->append_conf('postgresql.conf', "default_table_access_method = 'leopard'");
...
sub advance_wal
{
	...
	for (my $i = 0; $i < $n; $i++)
	{
		$node->safe_psql('postgres',
			"CREATE TABLE t () USING leopard; DROP TABLE t; SELECT pg_switch_wal();");
	}
	return;
}
