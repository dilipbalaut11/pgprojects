...
$primary->append_conf('postgresql.conf', "shared_preload_libraries = 'leopard'");
$primary->start;
$primary->safe_psql('postgres', "CREATE EXTENSION leopard WITH SCHEMA public");
$primary->stop;
$primary->append_conf('postgresql.conf', "default_table_access_method = 'leopard'");
...
$primary->safe_psql(
	'postgres', "
CREATE TABLE test1 (a int) USING leopard WITH (fillfactor = 10);
