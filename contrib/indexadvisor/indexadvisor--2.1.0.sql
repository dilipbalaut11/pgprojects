/*"""
.. function:: index_advisor_get_advise()

  Generates index advises based on quals collected so far
*/

CREATE FUNCTION @extschema@.index_advisor_get_advise(min_filter integer DEFAULT 1000, min_selectivity integer DEFAULT 30)
RETURNS SETOF text
AS 'MODULE_PATHNAME'
LANGUAGE C;
