...
$node_primary->safe_psql('postgres', "CREATE TABLE decoding(blah text) USING leopard;");
$node_primary->safe_psql('postgres',
...
$node_primary->safe_psql("dropme", "CREATE EXTENSION leopard WITH SCHEMA public");
