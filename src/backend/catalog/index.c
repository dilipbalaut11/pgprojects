			...
			bool parallel)
{
	...
	/* TODO: Currently parallel build is not supported for global indexes. */
				 ...
				 const ReindexParams *params)
{
	...
	foreach(indexId, indexIds)
	{
		...
		/*
		 * TODO: If this is a global index then we should not reindex it here
		 * for each partition, instead we should reindex them just once.
		 */
