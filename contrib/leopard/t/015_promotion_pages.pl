...
$alpha->append_conf('postgresql.conf', "shared_preload_libraries = 'leopard'");
$alpha->start;
$alpha->safe_psql('postgres', "CREATE EXTENSION leopard WITH SCHEMA public");
$alpha->stop;
$alpha->append_conf('postgresql.conf', "default_table_access_method = 'leopard'");
...
$alpha->safe_psql('postgres', 'create table test1 (a int) USING leopard');
...
$alpha->safe_psql('postgres', 'create table test2 (a int, b text) USING leopard');
$alpha->safe_psql('postgres',
