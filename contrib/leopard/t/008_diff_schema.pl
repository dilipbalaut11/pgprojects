...
$node_subscriber->safe_psql('postgres',
	"CREATE TABLE test_tab (a int primary key, b text, c timestamptz DEFAULT now(), d bigint DEFAULT 999, e int GENERATED BY DEFAULT AS IDENTITY) USING leopard"
);
...
$node_publisher->safe_psql('postgres', "CREATE TABLE test_tab2 (a int) USING leopard");

$node_subscriber->safe_psql('postgres', "CREATE TABLE test_tab2 (a int) USING leopard");
