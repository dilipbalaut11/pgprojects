...
createdb(ParseState *pstate, const CreatedbStmt *stmt)
{
	...
	{
		/*
		 * If a user has asked to create a database with log block then call
		 * CopyDatabaseWithWal, that will copy the database at block level and
		 * it will WAL log each copied block.  Otherwise call CopyDatabase
