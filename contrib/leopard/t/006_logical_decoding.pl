...
$node_primary->safe_psql('postgres',
	qq[CREATE TABLE decoding_test(x integer, y text) USING leopard;]);
...
$node_primary->safe_psql("otherdb", "CREATE EXTENSION leopard WITH SCHEMA public");
...
$node_primary->psql(
	'postgres', "
	CREATE TABLE tab_logical_slot (a int) USING leopard;
