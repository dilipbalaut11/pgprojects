...
$node_primary->safe_psql('postgres',
	"CREATE TABLE tab_int USING leopard AS SELECT generate_series(1,1000) AS a");
...
$node_primary_2->append_conf('postgresql.conf', "shared_preload_libraries = 'leopard'");
$node_primary_2->start;
$node_primary_2->safe_psql('postgres', "CREATE EXTENSION leopard WITH SCHEMA public");
$node_primary_2->stop;
$node_primary_2->append_conf('postgresql.conf', "default_table_access_method = 'leopard'");
...
$node_primary_2->safe_psql('postgres',
	"CREATE TABLE tab_int USING leopard AS SELECT 1 AS a");
